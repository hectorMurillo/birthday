    ...
    setTimeout(() => {
      ...
      const frame = () => {
        confetti({
          ...
          spread: 55,
          origin: { x: 0 },
          colors: ['#A42424', '#D38661', '#EEDABB', '#8E5A47']
        });
        confetti({
          particleCount: 5,
          angle: 120,
  ...
  return (
    ...
    >
      <div className="text-center mb-6">
        <h2 className="font-playfair text-2xl italic text-[#8E5A47] mb-2 font-medium">
          Hoy es el cumpleaños<br />de mi persona favorita
        </h2>
        <p className="font-serif text-sm tracking-widest text-[#8E5A47]/70 uppercase">
          {date}
        </p>
      </div>
      ...
      <motion.div 
        className="w-8 h-px bg-[#8E5A47]/30 my-6"
        initial={{ width: 0 }}
        animate={{ width: 32 }}
      />
