...
const initialPhotos = [
  { id: 7, src: "/foto7.webp", rot: 2, y: -2 },
  { id: 6, src: "/foto6.webp", rot: -4, y: 5 },
  { id: 5, src: "/foto5.webp", rot: 3, y: -1 },
  { id: 4, src: "/foto4.webp", rot: -2, y: 8 },
  { id: 3, src: "/foto8.webp", rot: 4, y: -5 },
  { id: 2, src: "/foto2.webp", rot: -3, y: 0 },
  { id: 1, src: "/foto1.webp", rot: -5, y: 10 },
];
  ...
  return (
    <div className="flex flex-col items-center w-full mt-2">
      <div className="text-center mb-2">
        <p className="font-serif italic text-[11px] text-[#8E5A47]/60 tracking-widest uppercase">
          Desliza la foto
        </p>
      </div>
      <div className="relative w-full max-w-[320px] h-[340px] mx-auto flex items-center justify-center">
        {cards.map((photo, i) => {
          ...
          return (
            ...
            >
              <div className="w-full aspect-square bg-gray-100 overflow-hidden rounded-sm relative pointer-events-none">
              ...
              <div className="absolute bottom-3 left-0 w-full flex justify-center space-x-2 text-[#8E5A47]/40 pointer-events-none">
                 <span className="text-xl font-script">✨</span>
              </div>
            </motion.div>
          );
        })}
