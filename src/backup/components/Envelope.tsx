...
export default function Envelope({ isOpen, onOpen }: EnvelopeProps) {
  return (
    <div className="relative w-full max-w-[340px] mx-auto mt-16 mb-24 perspective-[1000px]">
      ...
      <motion.div
        className="absolute top-0 left-0 w-full bg-[#F5EEDF] p-8 shadow-md text-left z-0 rounded-sm overflow-hidden"
      ...
      >
        ...
        <p className="font-playfair text-[#8E5A47] text-lg leading-relaxed mt-6 relative z-10">
        ...
        <p className="font-script text-2xl mt-8 text-right text-[#A42424]">
          Te quiero
        </p>

        {/* Final photo with phrase */}
        <div className="mt-12 flex flex-col items-center border-t border-[#8E5A47]/20 pt-8">
           <div className="w-full aspect-[4/3] bg-gray-200 rounded-sm overflow-hidden shadow-inner mb-4 relative">
              <img src="/foto1.webp" alt="Final Memory" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-black/10" />
           </div>
           <p className="font-playfair text-[#8E5A47] text-center italic text-xl">
      ...
      {/* Envelope Back */}
      <div className="relative w-full h-[220px] bg-[#E1CBA7] shadow-lg rounded-md z-10 overflow-hidden">
        {/* Envelope Flap (Top) */}
        <motion.div 
          className="absolute top-0 left-0 w-full h-[120px] bg-[#EEDABB] origin-top z-30 drop-shadow-md"
        ...
        <div 
          className="absolute bottom-0 left-0 w-full h-[140px] bg-[#DBC29C] z-20"
          style={{ clipPath: 'polygon(0 100%, 100% 100%, 50% 0)' }}
        />
        
        {/* Envelope Left/Right Flaps */}
        <div className="absolute top-0 left-0 w-full h-full bg-[#E5D0AD] z-10"
      ...
      {!isOpen && (
        ...
        >
          <div className="relative w-16 h-16 bg-gradient-to-br from-[#A42424] to-[#7A1515] rounded-full shadow-md flex items-center justify-center border-2 border-[#8E5A47]/20">
          ...
          <p className="mt-8 font-serif italic text-sm text-[#8E5A47]/70">
      ...
      <div className="absolute -bottom-16 left-0 w-full text-center">
        <p className="font-serif text-[10px] tracking-[0.2em] text-[#8E5A47]/40 uppercase">
          Hecho con amor
        </p>
      </div>
    </div>
